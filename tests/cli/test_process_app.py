...
def test_add_file():
    ...
    with patch('crowler.cli.app_factory.get_all_files', return_value=["file1.txt", "file2.txt"]) as mock_get_files, \
...
def test_list_files():
    ...
    with patch("crowler.db.process_file_db.summary_processing_files", 
              return_value=expected_output) as mock_summary:
